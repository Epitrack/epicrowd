<footer class="row footer-primary">
  <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1 organized">
    ...
    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 wrapper-proepi">
  ...
  <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1">
    <nav class="nav-secondary">
      <ul class="nav-secondary-list">
        ...
        <li class="nav-secondary-item">
          <a href="mailto:info@epicrowd.org?subject=Contact DDDMG" data-i18n="navSecondary.link05;[title]navSecondary.link05Title" class="nav-secondary-link" title="Contact us">contact us</a>
        </li>
      </ul>
    </nav>
  </div>
