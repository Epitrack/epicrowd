...
--
-- Host: localhost:8889
-- Generation Time: Nov 27, 2014 at 06:23 PM
...
-- Database: `dddmg_org`
--
CREATE DATABASE IF NOT EXISTS `dddmg_org` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `dddmg_org`;
...
`id` tinyint(3) unsigned NOT NULL,
  `name_pt` varchar(50) CHARACTER SET utf8 COLLATE utf8_swedish_ci NOT NULL,
  `name_en` varchar(50) CHARACTER SET utf8 COLLATE utf8_swedish_ci NOT NULL
...
INSERT INTO `countries` (`id`, `name_pt`, `name_en`) VALUES
...
--
ALTER TABLE `updates`
ADD CONSTRAINT `updates_ibfk_1` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`);
